...
import com.devweb.acervo.service.LocacaoService;
...
public class LocacaoController {
    ...
    public Locacao pegarIdLocacao(@PathVariable Long id) throws RelationTypeNotFoundException {
    ...
    public ResponseEntity<String> deletarLocacao(@PathVariable Long id) {
        try {
